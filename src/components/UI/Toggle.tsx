...
const Toggle = forwardRef<HTMLInputElement, ToggleProps>(
    (
        { value, setChecked, checked, children, className, textSide = "right" },
        ref
    ) => {
